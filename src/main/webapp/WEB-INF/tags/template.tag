...
<body class="skin-black" data-ng-app="myApp">
				...
				<ul class="nav navbar-nav">
								...
								<ul class="menu">
									<li>
										<!-- start message --> <a href="#">
											<div class="pull-left">
												<img src="<c:url value='/resources/img/26115.jpg'/>"
					...
					<li class="dropdown user user-menu"><a href="#"
						...
						<ul class="dropdown-menu dropdown-custom dropdown-menu-right">
							...
							<li data-ng-controller="loginCtrl"><a href="#"
								data-ng-click="logout()"><i
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="left-side sidebar-offcanvas">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li><a href="general"> <i class="fa fa-gavel"></i> <span>General</span>
					</a></li>

					<li><a href="basic_form"> <i class="fa fa-globe"></i> <span>Basic
								Elements</span>
					</a></li>

					<li><a href="simple"> <i class="fa fa-glass"></i> <span>Simple
								tables</span>
					</a></li>
		...
		<aside class="right-side">
			...
			<!-- /.content -->
			<div class="footer-main">Copyright &copy Hedi, 2016</div>
		</aside>
		<!-- /.right-side -->
	...
	<script src="<c:url value='/resources/js/plugins/chart.js'/>"
		type="text/javascript"></script>
	...
	<!-- calendar -->
	<script
		src="<c:url value='/resources/js/plugins/fullcalendar/fullcalendar.js'/>"
		type="text/javascript"></script>

	<!-- Director App -->
	<script src="<c:url value='/resources/js/Director/app.js'/>"
		type="text/javascript"></script>

	<!-- Director dashboard demo (This is only for demo purposes) -->
	<script src="<c:url value='/resources/js/Director/dashboard.js'/>"
		type="text/javascript"></script>
